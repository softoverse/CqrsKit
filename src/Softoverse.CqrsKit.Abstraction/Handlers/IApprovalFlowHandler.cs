    ...
    where TCommand : ICommand
{
    ...
    Task<Result<TResponse>> AfterAcceptAsync(CqrsContext context, CancellationToken ct = default);

    Task<Result<TResponse>> AfterRejectAsync(CqrsContext context, CancellationToken ct = default);
}
